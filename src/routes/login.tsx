    ...
    <Layout rightPanel={<HeroPanel />}>
      <div className="w-full max-w-sm mx-auto animate-fade-in">
        ...
        <button
          ...
          disabled={busy}
          className="mt-3 w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-border bg-card text-sm font-medium hover:bg-muted transition disabled:opacity-60"
        >
          <GoogleIcon />
